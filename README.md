...
- `/config/content/<path>.json` – backend-endepunkt som leverer øvrig runtime-innhold (f.eks. `tiltak/etterisolering-yttervegg.json`). Filer hentes fra `CONTENT_BUCKET` hvis tilgjengelig, ellers fra `content/`.
