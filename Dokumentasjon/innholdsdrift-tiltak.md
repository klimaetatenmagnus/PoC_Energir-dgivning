...
| 2025-11-22 | Første parity-pass på TiltakCardRenderer: gjeninnførte to-kolonners layout, fordelschips, interaktive tabs og støtte for stats/accordion slik at admin-previewen matcher legacy-kortene.                                                                                                                                                                                                                                                                                                                                                         | `src/components/FigmaBlokk/components/Tiltak/TiltakCardRenderer.tsx`, `src/components/FigmaBlokk/components/Tiltak/shared.ts`                                               |
...
| 2025-11-27 | **✅ Staging/prod-separasjon fullstendig fikset:** (1) Endret `CONTENT_BUCKET` i `energinokkelen-prod` til `energinokkelen-content-prod`, (2) La til `/config/content/*` proxy i admin-server som leser fra staging-bøtten for korrekt forhåndsvisning, (3) Endret `ADMIN_CONTENT_PROD_PREFIX` til `gs://energinokkelen-content-prod` (uten `/content`-suffix). Endringer i admin-UI vises nå kun i staging før wizard fullføres, og kun i prod etter "Publiser til prod"-steget. | `services/admin-server/index.ts`, Cloud Run env-vars, `Dokumentasjon/gcp-driftshandbok.md` |
