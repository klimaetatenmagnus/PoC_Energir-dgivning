...
export const Tetting: React.FC = () => {
  return (
    <g>
      ...
      {/* Chevron icon in top rectangle */}
      <svg x="485" y="8" width="24" height="24" viewBox="0 0 24 24" fill="none">
      ...
      {/* Chevron icon in bottom rectangle */}
      <svg x="485" y="68" width="24" height="24" viewBox="0 0 24 24" fill="none">
        <path fillRule="evenodd" clipRule="evenodd" d="M12 14.56L4.7466 7.5L3.75 8.47002L12 16.5L20.25 8.47002L19.2534 7.5L12 14.56Z" fill="#2A2859"/>
      </svg>
