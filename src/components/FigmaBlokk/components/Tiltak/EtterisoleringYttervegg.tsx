...
interface EtterisoleringYtterveggProps {
  onBack?: () => void;
  buildingType?: string;
  buildingData?: any;
}
  ...
  useEffect(() => {
    const fetchStotteordninger = async () => {
      try {
        ...
        const url = `http://localhost:3001/api/stotteordninger-live?gulliste=false&tiltak=etterisolering_fasade&bygningstype=${mappedType}`;
