  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      >
        ...
        <rect x="565" y="228" width="211" height="124" fill="#034B45" />
        <text x="589" y="252" width="149" height="24" fontFamily="Oslo Sans" fill="#FFFFFF" dominantBaseline="hanging">
          Årlig besparelse
        </text>
        <g>
          <rect
          ...
          />
          <svg x="728" y="248" width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ pointerEvents: 'none' }}>
        ...
        {showSourceTooltip && (
          <foreignObject x="565" y="158" width="211" height="90">
            <div
              xmlns="http://www.w3.org/1999/xhtml"
              style={{
