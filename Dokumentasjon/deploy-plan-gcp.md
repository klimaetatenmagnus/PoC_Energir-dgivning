...
- Kjør `npm run test:smoke -- --baseUrl=https://energinokkelen-168751968131.europe-north1.run.app` for å script-verifisere flere endpoints og samle logg (kan kjøres fra lokal maskin med `LIVE=1` ved behov). (Neste agent)
- Sett opp/frontend test i staging: koble Cloud CDN-url, manuell UI-sjekk og valider SPA-runtime mot `app.json`. (Neste agent)
