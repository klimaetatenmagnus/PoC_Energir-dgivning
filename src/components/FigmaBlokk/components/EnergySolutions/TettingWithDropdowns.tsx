  ...
  return (
    <div style={{ 
      ...
      >
        ...
        {/* Main text content */}
        <foreignObject x="60" y="0" width="465" height="400">
          <div xmlns="http://www.w3.org/1999/xhtml" style={{
            ...
            <p style={{ marginBottom: '16px' }}>
              Å stoppe trekken er noe av det enkleste og mest effektive du kan gjøre for å forbedre inneklimaet i et eldre bygg. Ofte skal det ikke mer til enn å tette rundt vinduer, dører eller lister for å merke stor forskjell. Tiltakene er som regel rimelige, krever lite inngrep – og kan gjennomføres på de fleste bygningstyper. Mange gjør det selv, og resultatet blir ofte både lunere rom og lavere strømregning. For å få et godt og varig resultat, er det viktig å bruke metoder og materialer som passer for eldre bygg.
            </p>
            <p>
              I eldre eneboliger trekker det ofte fra vinduer, dører eller overganger mellom rom og etasjer. Hvor det lekker mest avhenger av hvordan bygget er satt sammen. I hus med murvegger er det vanlig med trekk ved gulv, i hjørner eller mot loft og kjeller. Har du trehus, kan det trekke der materialene har beveget seg over tid, særlig rundt vinduer og dører. Små tiltak som tettelister, dyttestrimmel eller tetting rundt listverk kan gjøre stor forskjell – og gir ofte merkbart bedre komfort med enkle midler.
            </p>
          </div>
        </foreignObject>
        ...
        <svg x="573" y="93" width="17" height="16" viewBox="0 0 17 16" fill="none">
